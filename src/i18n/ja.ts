export default {
  ...
  about: {
    label: "クラブについて",
    body1:
      "札幌チェスクラブは、1990年代から北海道・札幌で活動を続けるチェスサークルです。月2回の例会と年3回の公式大会（北海道チェス選手権ほか）を開催し、小学生から社会人・シニアまで、年齢を問わず参加できます。",
    body2:
      "例会は札幌市中央区「かでる2.7」で開催。見学・初回参加は無料です。初心者の方には、教えてくれるメンバーがいるほか、クラブメンバーが道新文化センターで開講している入門チェス教室「たのしいチェス」もあります。北海道でチェスを始めたい方、対局相手を探している方は、お気軽にお越しください。",
  },
  activities: {
    label: "活動内容",
    meetup: "例会",
