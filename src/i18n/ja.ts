export default {
  ...
  about: {
    label: "クラブについて",
    body1:
      "札幌チェスクラブは、1990年代から北海道・札幌で活動を続けるチェスサークルです。月2回の例会と年3回の公式大会（北海道チェス選手権ほか）を開催しており、小学生から社会人・シニアまで、どなたでも参加できます。",
    body2:
      "例会の会場は札幌市中央区の「かでる2.7」。見学・初回参加は無料で、初心者の方には教えてくれるメンバーもいます。北海道でチェスを始めてみたい方も、対局相手を探している方も、まずはお気軽に遊びに来てください。",
  },
  activities: {
    label: "活動内容",
    meetup: "例会",
