      ...
      <body>
        <header class="topbar">
          <div class="topbar-inner">
            <a href="/sapporo-chess-club/announcements/" class="back">← お知らせ一覧</a>
          </div>
        </header>
        <main>
        ...
        <div class="explain">
          <strong>これは RSS フィードです。</strong><br/>
          このページは RSS リーダー (Feedly, Inoreader, NetNewsWire など) に登録して使います。<br/>
          以下の URL をお使いの RSS リーダーに貼り付けてください:
          <code id="feed-url"></code>
        </div>

        <div class="items-heading">最新のお知らせ</div>
